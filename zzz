...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background: #f5f5dc; /* Fond beige */
            color: #000; /* Caractères noirs */
        }
        header {
            ...
            padding: 1em 0;
            text-align: center;
            background-image: url('https://example.com/chaudiere.jpg'); /* Remplacez par l'URL de votre image */
    ...
    <div class="container">
        ...
        <section id="testimonials">
            ...
            <div class="testimonials">
                ...
                <p>"Une entreprise de plomberie et chauffage fiable avec des tarifs compétitifs. Je les recommande sans hésitation." - Nathalie Moreau</p>
            </div>
        </section>
